				...
				if(_lockable > 1) then { //if item has code lock on it
					...
					switch (_lockable) do { //generate random combinations depending on item type
						...
						case 2: { // 2 lockbox
							...
							_combinationDisplay = dayz_combination call _fnc_lockCode;
