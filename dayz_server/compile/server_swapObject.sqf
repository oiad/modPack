...
diag_log format["UPGRADE: %1 (%2) upgraded %3 @%4 %5",if (alive _activatingPlayer) then {name _activatingPlayer} else {"unknown player"},getPlayerUID _activatingPlayer,_class,mapGridPosition _activatingPlayer,getPosATL _activatingPlayer];
