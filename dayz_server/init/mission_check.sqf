...
_files = [
	'dayz_code\compile\fn_selfActions.sqf','dayz_code\compile\remote_message.sqf','dayz_code\compile\ui_selectSlot.sqf','dayz_code\init\compiles.sqf','dayz_code\init\variables.sqf','description.ext','init.sqf','mission.sqm','rules.sqf','scripts\buryActions.sqf','scripts\clickActions\config.sqf','scripts\clickActions\init.sqf','scripts\deployAnything\config.sqf','scripts\deployAnything\deploy.sqf','scripts\deployAnything\functions.sqf','scripts\deployAnything\init.sqf','scripts\deployAnything\pack.sqf','scripts\deployAnything\player_deploy.sqf','scripts\deployAnything\wrapper.sqf','scripts\locateVehicle.sqf','scripts\remoteVehicle\remoteVehicle.sqf','scripts\remoteVehicle\vehicleInfo.sqf','scripts\servicePoints\init.sqf','scripts\servicePoints\servicePointActions.sqf','scripts\takeClothes.sqf','scripts\traders\server_traders.sqf','scripts\virtualGarage\player_getVehicle.sqf','scripts\virtualGarage\player_removePad.sqf','scripts\virtualGarage\player_storeVehicle.sqf','scripts\virtualGarage\vehicleInfo.sqf','scripts\virtualGarage\virtualGarage.sqf','scripts\vkc\vehicleInfo.sqf','scripts\vkc\vehicleKeyChanger.sqf','scripts\zsc\bankDialog.sqf','scripts\zsc\checkWallet.sqf','scripts\zsc\givePlayer.sqf','scripts\zsc\playerHud.sqf','scripts\zsc\zscInit.sqf'
];
